...
from pyglet_pen.layouts import FloatingLayout, StackLayout, GridLayout
...
class GridLayoutView(View):
    ...
    def setup(self):
        ...
        title_layout = build_view_title(self, "Grid Layout")
        ...
        self.example_layout = GridLayout(
            width=300,
            height=300,
            n_cols=2,
            n_rows=2,
        ...
        self.example_layout.add_content(r1, 0, 0)
        ...
        self.example_layout.add_content(r2, 0, 1)
        ...
        self.example_layout.add_content(r3, 1, 0)
        ...
        self.example_layout.add_content(r4, 1, 1)
