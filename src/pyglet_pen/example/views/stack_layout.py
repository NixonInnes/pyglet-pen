...
class StackLayoutView(View):
    ...
    def setup(self):
        ...
        title_layout = build_view_title(self, "Stack Layout")
        ...
        self.example_layout = StackLayout(
            width=300,
            height=300,
            vertical_alignment="center",
            horizontal_alignment="center",
        ...
        button_stack_direction_horizontal = button_factory("Horizontal", self.callback_stack_direction_horizontal)
        button_stack_col1.add_content(button_stack_direction_horizontal)
        button_stack_direction_vertical = button_factory("Vertical", self.callback_stack_direction_vertical)
        button_stack_col1.add_content(button_stack_direction_vertical)
